...
// helps us detect certain situations an dsend custom errors
const customErrors = require('../../lib/custom_errors')

// sends a 404 when non-existent document is requested
...
// makes it so that a token MUST be passed for that route to be available
// also sets 'req.user'
